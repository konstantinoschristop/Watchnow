...
struct PersonView: View {
    ...
    fileprivate func constructNavigationBar(person: PersonResponse) -> NavigationBar {
    ...
    func constructDetailsView(person: PersonResponse) -> some View {
    ...
    fileprivate func createImageView(person: PersonResponse) -> some View {
